...
calibration_functions = {
    '14 November' : {
        'target': (1.850291070731134, 0.059984077536245885), 
        'scatter': (2.1602929779406614, 0.02114135454622181)},
    '16 November' : {
        'target': (2.4010694726553736, 0.08044663253223294), 
        'scatter': (2.4005128668328357, 0.022951667480381847)},
    '18 November' : {
        'target': (2.2111333553944745, 0.030713093938433706), 
        'scatter': (2.4930293607470744, 0.01786687591539348)},
    '21 November' : {
        'target': (2.43672762732042, 0.06889235331148837), 
        'scatter': (2.428982657981128, 0.017328744283926126)}
}
'''
